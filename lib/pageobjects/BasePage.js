        ...
        driver.wait(Until.elementIsVisible(element), timeout).then(function() {
            ...
            if (err.name === 'StaleElementReferenceError') {
                ...
                driver.wait(Until.elementIsVisible(element), timeout).then(function() {
                    ...
                    // After it is enabled check if it is really displayed
                    return driver.findElement(locator).isDisplayed();
                }, function (err_retry) /* error call back*/ {
                    console.log('waitForDisplayed::Element is still not visible after retry, error : ' + err_retry);
                    defer.reject(err_retry + ' : ' + locator);
    ...
    driver.wait(Until.elementLocated(locator), timeout).then(function () {
        ...
        driver.wait(Until.elementIsVisible(element), timeout).then(function() {
            ...
            if (err.name === 'StaleElementReferenceError') {
                ...
                driver.wait(Until.elementIsVisible(element), timeout).then(function() {
                    ...
                    driver.wait(Until.elementIsEnabled(element), timeout).then(function() {
                        ...
                        if (err_wait.name === 'StaleElementReferenceError') {
                            ...
                            console.log('waitForEnabled::Element is not enabled, error : ' + err_wait);
                            defer.reject(err_wait + ' : ' + locator);
                        }
                ...
                }, function (err_vis) /* error call back*/ {
                    console.log('waitForEnabled::Element is still not visible after retry, error : ' + err_vis);
                    defer.reject(err_vis + ' : ' + locator);
                });
            } else {
